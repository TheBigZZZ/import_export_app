...
def test_generate_invoice_pdf_basic():
    inv = SimpleNamespace(invoice_no='INV-001', invoice_date='2026-05-01', due_date='2026-05-31', subtotal=100.00, vat=10.00, discount=0.00, total_amount=110.00, customer_id=1)
    cust = SimpleNamespace(id=1, customer_name='ACME Corp', address='1 Road Ave')
    # simulate row-like items with attributes
    item = SimpleNamespace(id=1, invoice_id=1, product_id=42, quantity=2, unit_price=50.00, line_total=100.00)
