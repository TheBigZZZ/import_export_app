...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "account_type",
            sa.Enum(
                "asset", "liability", "equity", "income", "expense", name="accounttype"
            ),
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "currency", sa.String(length=10), nullable=False, server_default="BDT"
        ),
        sa.Column(
            "opening_balance", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "current_balance", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column("is_active", sa.Boolean(), nullable=False, server_default=sa.true()),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "credit_limit", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "opening_balance", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "purchase_price", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "selling_price", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "current_stock", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column(
            "reorder_level", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "movement_type",
            sa.Enum("IN", "OUT", "ADJUSTMENT", name="stockmovementtype"),
            nullable=False,
        ),
        sa.Column(
            "quantity_in", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column(
            "quantity_out", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column(
            "balance_qty", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column(
            "unit_cost", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column(
            "total_cost", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "voucher_type",
            sa.Enum("CPV", "CRV", "BPV", "BRV", "JV", "Contra", name="vouchertype"),
            nullable=False,
        ),
        ...
        sa.Column(
            "party_type",
            sa.Enum("customer", "supplier", "other", name="partytype"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "supplier_id", sa.Integer(), sa.ForeignKey("suppliers.id"), nullable=False
        ),
        ...
        sa.Column(
            "exchange_rate", sa.Numeric(10, 4), nullable=False, server_default="1.0000"
        ),
        sa.Column("fob_cost", sa.Numeric(18, 2), nullable=False, server_default="0.00"),
        sa.Column(
            "freight_cost", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "insurance_cost", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "customs_duty", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column("vat", sa.Numeric(18, 2), nullable=False, server_default="0.00"),
        sa.Column(
            "lc_charge", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "cf_charge", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "port_charge", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "transport_cost", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "other_cost", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "total_landed_cost",
            sa.Numeric(18, 2),
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "arrived", "costed", "posted", name="shipmentstatus"),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "shipment_id",
            sa.Integer(),
            sa.ForeignKey("import_shipments.id"),
            nullable=False,
        ),
        sa.Column(
            "product_id", sa.Integer(), sa.ForeignKey("products.id"), nullable=False
        ...
        sa.Column(
            "quantity", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column("unit", sa.String(length=50), nullable=False),
        sa.Column(
            "fob_unit_cost", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "total_amount", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "paid_amount", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "due_amount", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_table(
        ...
        sa.Column(
            "unit_price", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column(
            "cost_price", sa.Numeric(18, 4), nullable=False, server_default="0.0000"
        ),
        sa.Column("vat_rate", sa.Numeric(5, 2), nullable=False, server_default="0.00"),
        sa.Column("discount", sa.Numeric(18, 2), nullable=False, server_default="0.00"),
        sa.Column(
            "line_total", sa.Numeric(18, 2), nullable=False, server_default="0.00"
        ),
    )
