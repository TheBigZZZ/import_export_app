...
from ..schemas.party import CustomerCreate, CustomerRead, CustomerUpdate, PartyLedgerResponse
...
async def create_customer(
	...
	db: AsyncSession = Depends(get_db),
	_: object = Depends(require_roles("super_admin", "admin", "accounts_manager", "sales_manager")),
) -> CustomerRead:
