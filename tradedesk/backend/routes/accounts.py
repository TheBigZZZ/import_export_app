...
from ..schemas.accounting import AccountCreate, AccountRead, AccountTreeNode, AccountUpdate, LedgerResponse
...
async def update_account(
	...
	if account.is_system and payload.account_type is not None:
		raise HTTPException(status_code=status.HTTP_403_FORBIDDEN, detail="System account type cannot be changed")
