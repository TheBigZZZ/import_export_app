...
from ..schemas.inventory import ProductCreate, ProductRead, ProductUpdate, StockLedgerResponse, StockMovementCreate, StockMovementRead
...
async def list_products(
	...
	_: object = Depends(require_roles("super_admin", "admin", "inventory_manager", "viewer", "sales_manager", "purchase_manager")),
) -> list[ProductRead]:
