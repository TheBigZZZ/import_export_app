...
from ..schemas.purchase_ops import PurchaseOrderCreate, PurchaseOrderRead, PurchasePostResponse
...
async def list_purchases(
	...
	_: object = Depends(require_roles("super_admin", "admin", "purchase_manager", "accounts_manager", "viewer")),
...
async def post_purchase_order(
	order_id: int,
	db: AsyncSession = Depends(get_db),
	user: User = Depends(require_roles("super_admin", "admin", "purchase_manager", "accounts_manager")),
