...
try:
    with httpx.Client(timeout=10.0) as client:
        r = client.post(f"{BASE}/api/auth/login", json={"username": ADMIN_USER, "password": ADMIN_PASS}, auth=None)
        ...
        payload = {"username": uname, "full_name": "Test User", "email": "test@example.com", "password": "password123", "role": "viewer"}
